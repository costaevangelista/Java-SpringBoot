package br.com.costawebs.cursomc.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> aataIntegrity(DataIntegrityException e, HttpServletRequest request){
