...
import br.com.costawebs.cursomc.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto, ConstraintValidatorContext context) {
		...
		/*
		 * Cliente aux = clienteRepository.findByEmail(objDto.getEmail()); if (aux !=
		 * null) { list.add(new FieldMessage("email", "Email já existente")); }
		 */
